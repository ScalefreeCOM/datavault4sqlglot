-- STAGE -- Ghost Records — unknown (all-0) + error (all-f) rows via UNION ALL
...
SELECT
  ...
  '00000000000000000000000000000000' AS "HK_L_ORD_CUST",
...
SELECT
  ...
  'ffffffffffffffffffffffffffffffff' AS "HK_L_ORD_CUST",
