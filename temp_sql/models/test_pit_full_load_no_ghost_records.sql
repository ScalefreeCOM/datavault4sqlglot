-- PIT — Full Load — 2 sats, refer_to_ghost_records=False (NULL for missing sat entry)
...
WITH pit_records AS (
  SELECT
    ...
    snap.SDTS AS SDTS,
    sat_customer_details.HK_CUSTOMER_H AS hk_sat_customer_details,
    sat_customer_details.ldts AS ldts_sat_customer_details,
    sat_customer_contact.HK_CUSTOMER_H AS hk_sat_customer_contact,
    sat_customer_contact.ldts AS ldts_sat_customer_contact
